...
//
//        MyLyricsArrayAdapter adapter = new MyLyricsArrayAdapter(this, android.R.layout.simple_list_item_1,
...
//                Toast.makeText(LyricsActivity.this, artists, Toast.LENGTH_LONG).show();
